...
@push('subnav-title')
<span style="color: white;  font-size: 25px;">Contact Lists</span>
@endpush
...
<div class="container mt-4"> <!-- Add some margin-top for spacing -->
    <div class="row">
        <div class="col-md-8"> <!-- Adjusted column width for search and dropdowns -->
            <form action="#" method="GET"> <!-- Replace # with your search route -->
                <div class="input-group">
                    ...
                    <!-- Search Input -->
                    <input type="text" class="form-control" placeholder="Search contacts..." aria-label="Search contacts" aria-describedby="search-button">
                    <!-- Search Button -->
        ...
        <div class="col-md-4 d-flex justify-content-end"> <!-- Separate column for buttons -->
            <!-- Add New Button -->
<button class="btn btn-success me-2" type="button" id="add-new-button" data-bs-toggle="modal" data-bs-target="#addNewModal">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td>001</td>
                            <td>John Doe</td> 
                            <td style="width: auto;"> <!-- Set width to auto -->
